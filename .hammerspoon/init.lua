...
h_bind("d", function() hs.eventtap.keyStroke({"cmd"}, "right", keyDelay) end, true)
hs_bind("d", function() hs.eventtap.keyStroke({"cmd", "shift"}, "right", keyDelay) end, true)
...
h_bind("f", function() hs.eventtap.keyStroke({"alt"}, "right", keyDelay) end, true)
hs_bind("f", function() hs.eventtap.keyStroke({"alt", "shift"}, "right", keyDelay) end, true)
